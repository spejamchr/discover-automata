...
const plainTextTranlations = [
  ...
  `The first generation of cells can be created randomly, or [...]`,
  `The hue can be adjusted to render the emulator using [...]`,
  `The numeric labels can be toggled on or off.`,
  `There are several settings that control how the emulator is [...]`,
